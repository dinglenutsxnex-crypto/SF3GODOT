	...
	public class WWW : CustomYieldInstruction, System.IDisposable
	{
		...
		void SendRequest(string requestData = "")
		{
			...
			else
			{
				...
				requestNode.RequestCompleted += _on_request_completed;

				requestNode.Request(_url);
			}
		}


		void _on_request_completed(long result, long response_code, string[] headers, byte[] body)
		{
			_bytes = body;
			_isDone = true;
