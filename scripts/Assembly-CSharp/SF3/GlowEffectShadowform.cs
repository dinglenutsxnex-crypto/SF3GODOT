...
namespace SF3
{
	public partial class GlowEffectShadowform : MonoBehaviour
	{
		...
		public Shader glowDissolveShader;

		public bool useDissolveGlow;
		...
		public void OnPreRender()
		{
			if ((int)glowMode % 2 == 0)
			{
				...
				shaderCamera.RenderWithShader((!useDissolveGlow) ? glowReplaceShader : glowDissolveShader, "RenderType");
			}
		}
