...
namespace DG.Tweening
{
	public static class ShortcutExtensions
	{
		...
		{
			return DOTween.To(() => target.backgroundColor, delegate(ColorWrapper x)
			{
		...
		public static Tweener DOColor(this Material target, Color endValue, string property, float duration)
		{
			...
			return DOTween.To(() => target.GetColor(property), delegate(ColorWrapper x)
			{
		...
		public static Tweener DOFade(this Material target, float endValue, string property, float duration)
		{
			...
			return DOTween.ToAlpha(() => target.GetColor(property), delegate(ColorWrapper x)
			{
				target.SetColor(property, x);
			}, endValue, duration).SetTarget(target);
		}
		...
		{
			return DOTween.To(() => target.mainTextureOffset, delegate(Vector2Wrapper x)
			{
		...
		public static Tweener DOOffset(this Material target, Vector2 endValue, string property, float duration)
		{
			...
			return DOTween.To(() => target.GetTextureOffset(property), delegate(Vector2Wrapper x)
			{
		...
		{
			return DOTween.To(() => target.mainTextureScale, delegate(Vector2Wrapper x)
			{
		...
		public static Tweener DOTiling(this Material target, Vector2 endValue, string property, float duration)
		{
			...
			return DOTween.To(() => target.GetTextureScale(property), delegate(Vector2Wrapper x)
			{
		...
		public static Tweener DOVector(this Material target, Vector4 endValue, string property, float duration)
		{
			...
			return DOTween.To(() => target.GetVector(property), delegate(Vector4Wrapper x)
			{
		...
		{
			return DOTween.To(() => target.position, delegate(Vector3Wrapper x)
			{
		...
		{
			TweenerCore<QuaternionWrapper, Vector3Wrapper, QuaternionOptions> tweenerCore = DOTween.To(() => target.rotation, delegate(QuaternionWrapper x)
			{
				target.MoveRotation(x);
			}, endValue, duration);
		...
		public static Sequence DOJump(this Rigidbody target, Vector3 endValue, float jumpPower, int numJumps, float duration, bool snapping = false)
		{
			...
			s.Append(DOTween.To(() => target.position, delegate(Vector3Wrapper x)
			{
				target.MovePosition(x.value);
				...
				})).Join(DOTween.To(() => target.position, delegate(Vector3Wrapper x)
			{
				target.MovePosition(x.value);
			}, new Vector3(0f, 0f, endValue.z), duration).SetOptions(AxisConstraint.Z, snapping).SetEase(Ease.Linear)).Join(DOTween.To(() => target.position, delegate(Vector3Wrapper x)
			{
				target.MovePosition(x.value);
		...
		{
			return DOTween.To(() => new Vector2(target.startWidth, target.endWidth), delegate(Vector2Wrapper x)
			{
		...
		{
			return DOTween.To(() => target.localPosition, delegate(Vector3Wrapper x)
			{
		...
		{
			TweenerCore<QuaternionWrapper, Vector3Wrapper, QuaternionOptions> tweenerCore = DOTween.To(() => target.localRotation, delegate(QuaternionWrapper x)
			{
		...
		{
			return DOTween.To(() => target.localScale, delegate(Vector3Wrapper x)
			{
				target.localScale = x;
			}, endValue, duration).SetTarget(target);
		}
		...
		{
			return DOTween.To(endValue: new Vector3(endValue, endValue, endValue), getter: () => target.localScale, setter: delegate(Vector3Wrapper x)
			{
				target.localScale = x;
		...
		public static Sequence DOLocalJump(this Transform target, Vector3 endValue, float jumpPower, int numJumps, float duration, bool snapping = false)
		{
			...
			bool offsetYSet = false;
			Sequence s = DOTween.Sequence();
			s.Append(DOTween.To(() => target.localPosition, delegate(Vector3Wrapper x)
			{
				target.localPosition = x;
			}, new Vector3(endValue.x, 0f, 0f), duration).SetOptions(AxisConstraint.X, snapping).SetEase(Ease.Linear)
				.OnUpdate(delegate
				...
				})).Join(DOTween.To(() => target.localPosition, delegate(Vector3Wrapper x)
			{
				target.localPosition = x;
			}, new Vector3(0f, 0f, endValue.z), duration).SetOptions(AxisConstraint.Z, snapping).SetEase(Ease.Linear)).Join(DOTween.To(() => target.localPosition, delegate(Vector3Wrapper x)
			{
				target.localPosition = x;
			}, new Vector3(0f, jumpPower, 0f), duration / (float)(numJumps * 2)).SetOptions(AxisConstraint.Y, snapping).SetEase(Ease.OutQuad)
				.SetRelative()
		...
		public static Tweener DOBlendableMoveBy(this Transform target, Vector3 byValue, float duration, bool snapping = false)
		{
			...
			return DOTween.To(() => to, delegate(Vector3Wrapper x)
			{
				Vector3 vector = x.value - to;
				to = x;
		...
		public static Tweener DOBlendableRotateBy(this Transform target, Vector3 byValue, float duration, RotateMode mode = RotateMode.Fast)
		{
			...
			TweenerCore<QuaternionWrapper, Vector3Wrapper, QuaternionOptions> tweenerCore = DOTween.To(() => to, delegate(QuaternionWrapper x)
			{
				Quaternion quaternion = x.value * Quaternion.Inverse(to);
				to = x;
